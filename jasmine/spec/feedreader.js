...
$(function() {
    ...
    describe('RSS Feeds', function() {
        ...
        it('The allFeeds variable are defined and it is not empty', function() {
         ...
         */
          ...
          it('Looped through each feed in the allFeeds object and ensured it has a name defined and that the name is not empty.', function () {
         ...
         */
         ...
         it('Looped through each feed in the allFeeds object and ensured it has a URL defined and that the URL is not empty.', function () {
            for (let i = 0; i < allFeeds.length; i++) {
